  ...
  <div class="row">
    ...
    <form action="Search.php" method="POST">
      <div class="overflow-auto container-fluid">
        <div>
          <h3 class="rounded-top ps-1 pb-1" >BOOKING</h3>
        </div>
        <div class="container-sm">
            ...
            <div class="card-body">
              ...
              <!-- ... -->
                <div class="row" style="margin-top:-15px;">
                  <div class="col-sm">
                    <div class="mb-2">
                      <label id="origin-label" for="origin-input" class="form-label">Fly From</label>
                        <div class="input-group">
                        <!-- ... -->
                          <div class="mb-2">
                            <div class="input-group">
                              <span class="input-group-text"><i class="bi-pin-map"></i> </span>
                              <input type="text" class="form-control" list="origin-options" id="origin-input" placeholder="Location" aria-describedby="origin-label" name="SourceCity" />
                  ...
                  <div class="col-sm">
                    <div class="mb-2">
                      <label id="destination-label" for="destination-input" class="form-label">Arrive To</label>
                      <div class="input-group">
                      <!-- ... -->
                        <div class="mb-2">
                          <div class="input-group">
                            <span class="input-group-text"><i class="bi-pin-map-fill"></i> </span>
                            <input type="text" class="form-control" list="Destination-options" id="Destination-input" placeholder="Location" aria-describedby="Destination-label" name="Destination" />
          ...
          <div class="row">
            ...
            <!-- ... -->
            <button class="w-100 btn btn-lg" style="background-color:rgb(11, 140, 67); color:white;" type="submit">Search</button>
          </div>
        </div>
      </div>
    </form>
